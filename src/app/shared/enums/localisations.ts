export class LocKeys {
  ...
  static ENROL_NO_CONSENT_MESSAGE = new LocKeys('ENROL_NO_CONSENT_MESSAGE')
  static ENROL_ABOUT_HEADING = new LocKeys('ENROL_ABOUT_HEADING')
  static ENROL_PURPOSE_OF_THE_STUDY = new LocKeys('ENROL_PURPOSE_OF_THE_STUDY')
  ...
  static CONSENT_FULL_CONSENT_REQUIRED_TITLE = new LocKeys('CONSENT_FULL_CONSENT_REQUIRED_TITLE')
